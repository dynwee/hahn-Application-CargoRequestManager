...
{
    public class UpdateVehicleAllocationDtoValidator : AbstractValidator<UpdateVehicleAllocationDto>
    {
        private readonly IVehicleTypeRepository _vehicleTypeRepository;
        private readonly ICargoRequestRepository _cargoRequestRepository;

        public UpdateVehicleAllocationDtoValidator(IVehicleTypeRepository vehicleTypeRepository
